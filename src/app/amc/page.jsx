    ...
    overview: (
      <div>
        ...
        <div style={{ marginTop: '30px', borderRadius: '24px', overflow: 'hidden', boxShadow: '0 20px 40px rgba(5,64,120,0.1)' }}>
           <Image src="/amc image overview/new.png" alt="Customer Service Professional" width={1200} height={600} style={{ width: '100%', height: 'auto', display: 'block', objectFit: 'cover' }} />
        </div>
      </div>
    ),
    range: (
